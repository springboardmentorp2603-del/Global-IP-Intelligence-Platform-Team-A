...
const Sidebar = () => {
  ...
  const { logout, user, isAuthorized } = useAuth();
  ...
  const menuItems = [
    ...
    },
    {
      ...
      path: "/search",
      icon: Search,
      visible: isAuthorized('SEARCH')
    },
    {
      name: "Alerts",
      path: "/alerts",
      icon: Bell,
      visible: isAuthorized('TRACKING')
    },
    {
      name: "Analytics",
      path: "/analytics",
      icon: BarChart3,
      visible: isAuthorized('ANALYTICS')
    },
    {
      name: "Analyst Requests",
      path: "/admin/analyst-requests",
      icon: FileText,
      visible: isAuthorized('USER_MANAGEMENT')
    },
    {
    ...
    },
    {
      ...
      path: "/admin/logs",
      icon: FileText,
      visible: isAuthorized('API_MONITORING')
    },
    {
      name: "Activity",
      path: "/admin/activity",
